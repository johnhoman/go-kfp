...
/* ArchiveExperimentParams contains all the parameters to send to the API endpoint
   for the archive experiment operation.
...
// WithDefaults hydrates default values in the archive experiment params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ArchiveExperimentParams) WithDefaults() *ArchiveExperimentParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the archive experiment params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ArchiveExperimentParams) SetDefaults() {
