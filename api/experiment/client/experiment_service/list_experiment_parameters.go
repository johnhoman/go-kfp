...
/* ListExperimentParams contains all the parameters to send to the API endpoint
   for the list experiment operation.
...
// WithDefaults hydrates default values in the list experiment params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListExperimentParams) WithDefaults() *ListExperimentParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the list experiment params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListExperimentParams) SetDefaults() {
	var (
		resourceReferenceKeyTypeDefault = string("UNKNOWN_RESOURCE_TYPE")
	)

	val := ListExperimentParams{
