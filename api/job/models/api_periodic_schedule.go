...
// ContextValidate validates this api periodic schedule based on context it is used
func (m *APIPeriodicSchedule) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
